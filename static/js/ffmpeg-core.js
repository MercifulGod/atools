var createFFmpegCore = (function () {
    ...
    return (
        function (createFFmpegCore) {
            ...
            var fa = [], ha = "./this.program";

            function ja(a, b) {
                throw b;
            }

            var ka = !1, la = !1, h = !1, ma = !1;
            ...
            var ya = f.print || console.log.bind(console), u = f.printErr || console.warn.bind(console);
            ...
            if (l) Ca = f.wasmMemory, oa = f.buffer; else if (f.wasmMemory) Ca = f.wasmMemory; else if (Ca = new WebAssembly.Memory({
                initial: Ta / 65536,
                maximum: Ta / 65536,
                shared: !0
            ...
            function kb() {
                return Ba || !ka && !la || "function" !== typeof fetch || gb("file://") ? Promise.resolve().then(jb) : fetch(hb, {credentials: "same-origin"}).then(function (a) {
            ...
            f.dynCall = function (a, b, c) {
                var d;
                -1 != a.indexOf("j") ? d = c && c.length ? f["dynCall_" + a].apply(null, [b].concat(c)) : f["dynCall_" + a].call(null, b) : d = H.get(b).apply(null, c);
                return d
            };
            var pb = 0, qb = 0, rb = 0;
            ...
            function tb(a, b) {
                ...
                var c = Atomics.load(E, M.Uf >> 2), d = 0;
            ...
            var M = {
                Oh: 1, mj: {Hh: 0, Ih: 0}, Ff: [], Jf: [], kj: function () {
                }, oi: function () {
                    M.wf = Ma(232);
                    ...
                    var b = pb | 0;
                    b && (Atomics.store(F, b + 4 >> 2, a), Atomics.store(F, b + 0 >> 2, 1), Atomics.store(F, b + 60 >> 2, 1), Atomics.store(F, b + 64 >> 2, 0), M.dh(), tb(b + 0, 2147483647), sb(0, 0, 0), threadInfoStruct = 0, l && postMessage({cmd: "exit"}))
                }, Oi: function () {
                    M.dh();
                ...
                Hi: function () {
                    ...
                    a.onmessage = function (c) {
                        ...
                        if (d.targetThread && d.targetThread != (pb | 0)) {
                        ...
                        } else if ("processQueuedMainThreadWork" === e) Ab(); else if ("spawnThread" === e) Bb(c.data); else if ("cleanupThread" === e) vb(d.thread); else if ("killThread" ===
                            e) {
                            c = d.thread;
                            ...
                            c.worker.xf = void 0
                        } else if ("cancelThread" === e) ub(d.thread); else if ("loaded" === e) a.loaded = !0, b && b(a), a.ng && (a.ng(), delete a.ng); else if ("print" === e) ya("Thread " + d.threadId + ": " + d.text); else if ("printErr" === e) u("Thread " + d.threadId + ": " + d.text);
                        else if ("alert" === e) alert("Thread " + d.threadId + ": " + d.text); else if ("exit" === e) a.xf && Atomics.load(F, a.xf.Kh + 68 >> 2) && M.zg(a); else if ("exitProcess" === e) {
                            noExitRuntime = !1;
                            try {
                                Cb(d.returnCode)
                            } catch (k) {
                    ...
                    a.postMessage({cmd: "load", urlOrBlob: f.mainScriptUrlOrBlob || _scriptDir, wasmMemory: Ca, wasmModule: Da})
                }, Vh: function () {
            ...
            function Gb(a, b) {
                if (0 === a) a = Date.now(); else if (1 === a || 4 === a) a = Db(); else return Eb(28), -1;
                E[b >> 2] = a / 1E3 | 0;
                E[b + 4 >> 2] = a % 1E3 * 1E6 | 0;
                return 0
            }
            ...
            var Yb = {
                    ...
                    wh: function (a) {
                        if (!a.input.length) {
                            var b = null;
                            if (h) {
                                var c = Buffer.Rf ? Buffer.Rf(256) : new Buffer(256), d = 0;
                                try {
                    ...
                    Cf: null, hf: function () {
                        ...
                        P.Cf || (P.Cf = {
                            ...
                            file: {
                                ...
                                stream: {sf: P.cf.sf, read: P.cf.read, write: P.cf.write, eg: P.cf.eg, Vf: P.cf.Vf, Wf: P.cf.Wf}
                            },
                            link: {node: {zf: P.bf.zf, mf: P.bf.mf, readlink: P.bf.readlink}, stream: {}},
                            kh: {
                                node: {zf: P.bf.zf, mf: P.bf.mf},
                                stream: O.Zh
                            }
                        ...
                        if (a.ff != b) if (0 == b) a.af = null, a.ff = 0; else {
                            if (!a.af || a.af.subarray) {
                                var c = a.af;
                                a.af = new Uint8Array(b);
                                c && a.af.set(c.subarray(0, Math.min(b, a.ff)))
                            } else if (a.af || (a.af = []), a.af.length > b) a.af.length = b; else for (; a.af.length < b;) a.af.push(0);
                            a.ff = b
                        }
                    }, bf: {
                        zf: function (a) {
                        ...
                        read: function (a, b, c, d, e) {
                            ...
                            if (a.af.subarray && b.subarray) a.af.set(b.subarray(c,
                                c + d), e); else for (g = 0; g < d; g++) a.af[e + g] = b[c + g];
                    ...
                    ef: function (a, b) {
                        ...
                        for (d = 0; d < a.length; d++) {
                            ...
                            if (!g || b.vf) for (g =
                                                     0; O.Lf(e.mode);) if (e = O.readlink(c), c = Ub(Qb(c), e), e = O.ef(c, {$g: b.$g}).node, 40 < g++) throw new O.$e(32);
                        }
                    ...
                    rename: function (a, b) {
                        var c = Qb(a), d = Qb(b), e = Rb(a), g = Rb(b);
                    ...
                    rmdir: function (a) {
                        var b = O.ef(a, {parent: !0}).node, c = Rb(a), d = O.Af(b, c), e = O.wg(b, c, !0);
                        if (e) throw new O.$e(e);
                    ...
                    unlink: function (a) {
                        var b = O.ef(a,
                            {parent: !0}).node, c = Rb(a), d = O.Af(b, c), e = O.wg(b, c, !1);
                        if (e) throw new O.$e(e);
                    ...
                    chmod: function (a, b, c) {
                        ...
                        d.bf.mf(d, {mode: b & 4095 | d.mode & -4096, timestamp: Date.now()})
                    },
                    lchmod: function (a, b) {
                        O.chmod(a, b, !0)
                    },
                    ...
                    open: function (a, b, c, d, e) {
                        ...
                        b &= -131713;
                        d = O.mh({node: g, path: O.Hf(g), flags: b, seekable: !0, position: 0, cf: g.cf, Vi: [], error: !1}, d, e);
                    ...
                    read: function (a,
                        ...
                        if (!g) e = a.position; else if (!a.seekable) throw new O.$e(70);
                    ...
                    write: function (a, b, c, d, e, g) {
                        ...
                        if (!k) e = a.position; else if (!a.seekable) throw new O.$e(70);
                    ...
                    writeFile: function (a, b, c) {
                        ...
                        } else if (ArrayBuffer.isView(b)) O.write(a, b, 0, b.byteLength, void 0, c.Yh); else throw Error("Unsupported data type");
                        O.close(a)
                    },
                    cwd: function () {
                        return O.nh
                    ...
                    Kg: function (a, b) {
                        ...
                        var d =
                            {vg: !1, exists: !1, error: 0, name: null, path: null, object: null, Bi: !1, Di: null, Ci: null};
                        try {
                            c = O.ef(a, {parent: !0}), d.Bi = !0, d.Di = c.path, d.Ci = c.node, d.name = Rb(a), c = O.ef(a, {vf: !b}), d.exists = !0, d.path = c.path, d.object = c.node, d.name = c.node.name, d.vg = "/" === c.path
                        } catch (e) {
                            d.error = e.df
                        }
                        return d
                    ...
                    vj: function (a, b,
                        ...
                        e.onsuccess = function () {
                            var g = e.result.transaction([O.dg], "readwrite"), k = g.objectStore(O.dg), m = 0, r = 0, q = a.length;
                    ...
                    lj: function (a, b, c) {
                        ...
                        e.onsuccess = function () {
                            ...
                            var m = k.objectStore(O.dg), r = 0, q = 0, t = a.length;
            ...
            function lc(a, b) {
                ...
                try {
                    ...
                    if (b & -8) var c = -28; else {
                        var d;
                        (d = O.ef(a, {vf: !0}).node) ? (a = "", b & 4 && (a += "r"), b & 2 && (a += "w"), b & 1 && (a += "x"), c = a && O.If(d, a) ? -2 : 0) : c = -44
                    }
                    return c
                } catch (e) {
                ...
                try {
                    if (-1 === (a | 0) || 0 === b) var c = -28; else {
                        ...
                        if (d && b === d.ti) {
                            var e = O.yf(d.fd);
                            if (d.Fi & 2) {
                                var g = d.flags, k = d.offset, m = v.slice(a, a + b);
                                O.Wf(e, m, k, b, g)
                            }
                            fc[a] = null;
                            d.Ig && zb(d.wi)
            ...
            function yc(a, b, c) {
                ...
                try {
                    for (var d = c = 0; d < b; d++) {
                        var e = a + 8 * d, g = Qa[e + 4 >> 1], k = 32, m = O.yf(E[e >> 2]);
            ...
            var R = {
                hf: function () {
                    ...
                    b &= -526337;
                    c && assert(1 == b == (6 == c));
                    a = {family: a, type: b, protocol: c, kf: null, error: null, mg: {}, pending: [], $f: [], nf: R.pf};
                    b = R.yg();
                    c = O.createNode(R.root, b, 49152, 0);
                    c.ag = a;
                    b = O.mh({path: b, node: c, flags: O.Ch("r+"), seekable: !1, cf: R.cf});
                    a.stream = b;
                    return a
                }, li: function (a) {
                    ...
                    sg: function (a, b, c) {
                        ...
                        if (d) if (d._socket) b = d._socket.remoteAddress, c = d._socket.remotePort; else {
                            ...
                            var m = void 0;
                            "null" !== k && (k = k.replace(/^ +| +$/g, "").split(/ *, */), m = h ? {protocol: k.toString()} : k);
                        ...
                        var b = 0, c = 1 === a.type ? R.pf.ug(a, a.rf, a.uf) : null;
                        ...
                        var d = c.data.byteLength || c.data.length, e = c.data.byteOffset || 0, g = c.data.buffer || c.data;
                        b = Math.min(b, d);
                        var k = {
                            buffer: new Uint8Array(g, e, b), gf: c.gf,
                            port: c.port
                        };
            ...
            function Ec(a) {
                ...
                for (b = c = 0; b < a.length; b++) if ("string" === typeof a[b]) if ("Z" === a[b]) {
                    ...
                    --c
                } else d[b + c] = Fc(parseInt(a[b], 16)); else d[b + c] = a[b];
            ...
            function Qc(a, b) {
                ...
                try {
                    ...
                    switch (a) {
                        case 1:
                            var d = Q(), e = Q(), g = Q(), k = R.createSocket(d, e, g);
                            return k.stream.fd;
                        case 2:
                            k = b();
                            var m = c();
                        ...
                        case 15:
                            k = b();
                            var W = Q(), db = Q(), K = Q(), Y = Q();
                            return 1 === W && 4 === db ? (E[K >> 2] = k.error, E[Y >> 2] = 4, k.error = null, 0) : -50;
                        case 16:
                            k = b();
                            w = Q();
                            Q();
                            var ia = E[w + 8 >> 2], na = E[w + 12 >> 2], ua = E[w >> 2], he = E[w + 4 >> 2];
                            if (ua) {
                                m = Oc(ua, he);
                                if (m.df) return -m.df;
                                var ie = m.port;
                            ...
                            for (X = B = 0; X < na; X++) {
                                var $b = E[ia + 8 * X >> 2], ac = E[ia + (8 * X + 4) >> 2];
                        ...
                        case 17:
                            ...
                            for (X = 0; 0 < bc && X < na; X++) if ($b = E[ia + 8 * X >> 2], ac = E[ia + (8 * X + 4) >> 2]) B = Math.min(ac, bc), x = I.buffer.subarray(k, k + B), v.set(x, $b + k), k += B, bc -= B;
                            return k;
                        default:
                            return -52
                    }
            ...
            var Zc = 1, $c = [], S = [], ad = [], bd = [], cd = [], T = [], dd = [], ed = [], fd = [], gd = {}, hd = {}, id = 4;
            ...
            function vd(a, b, c, d) {
                if (c) if (a = V.getUniform(S[a], T[b]), "number" == typeof a || "boolean" == typeof a) switch (d) {
                    case 0:
                        E[c >> 2] = a;
                        break;
                    case 2:
            ...
            function wd(a, b, c, d) {
                if (c) if (a = V.getVertexAttrib(a, b), 34975 == b) E[c >> 2] = a && a.name; else if ("number" == typeof a || "boolean" == typeof a) switch (d) {
                    case 0:
                        E[c >> 2] = a;
                        break;
                    case 2:
            ...
            function xd(a, b, c, d, e) {
                ...
                var g = 31 - Math.clz32(a.BYTES_PER_ELEMENT), k = id;
                return a.subarray(e >> g, e + d * (c * ({5: 3, 6: 4, 8: 2, 29502: 3, 29504: 4}[b - 6402] || 1) * (1 << g) + k - 1 & -k) >> g)
            }
            ...
            var Bd = [], Cd = [], Dd = [0, "undefined" !== typeof document ? document : 0, "undefined" !== typeof window ? window : 0];
            ...
            function Fd(a, b, c) {
                ...
                if (d.Eh || !d.$i) d.Eh && (d = d.Eh), a = !1, d.qg && d.qg.pg && (a = d.qg.pg.getParameter(2978), a = 0 === a[0] && 0 === a[1] && a[2] === d.width && a[3] === d.height), d.width = b, d.height = c, a && d.qg.pg.viewport(0, 0, b, c); else {
                    if (d.rg) {
                        a = a ? C(a) : "";
                        d = E[d.rg + 8 >> 2];
                        var e = A(), g = Ha(12), k = 0;
            ...
            var Id = ["default", "low-power", "high-performance"], Jd = {};
                ...
                try {
                    a:{
                        for (var e = jc(a), g = a = 0; g < c; g++) {
                            var k = E[b + (8 * g + 4) >> 2], m = O.read(e, y, E[b + 8 * g >> 2], k, void 0);
                            if (0 > m) {
                                var r = -1;
                                break a
                            }
            ...
            function Td(a, b, c, d) {
                ...
                a = C(a);
                g = Dc(a);
                if (null !== g) if (0 === r || 2 === r) r = 2; else if (10 === r && m & 8) g = [0, 0, Ud(65535), g], r = 10; else return -2; else if (g = Ec(a), null !== g) if (0 === r || 10 === r) r = 10; else return -2;
            ...
            function Bb(a) {
                ...
                var e = a.Qf + a.bg;
                d = M.Df[a.Zf] = {worker: b, Qf: a.Qf, bg: a.bg, Jg: a.Jg, Kh: a.Zf, threadInfoStruct: a.Zf};
            ...
            var $d = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], ae = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];

            function be(a, b) {
                for (a = new Date(a.getTime()); 0 < b;) {
                    var c = a.getMonth(), d = (Yd(a.getFullYear()) ? $d : ae)[c];
            ...
            var Fe = {
                c: function (a, b, c, d) {
                    ...
                    return Nb(a, b)
                }, Ma: kc, Ea: lc, t: mc, Na: nc, Ka: oc, Ha: pc, U: rc, Oa: sc, Pa: tc, za: uc, Aa: wc, Da: function () {
                    return -63
                }, X: xc, La: yc, Ja: zc, Ca: Ac, xa: Bc, Ga: Cc, Ia: function () {
                    return 0
                },
                q: Qc, W: Rc, Fa: function (a) {
                    try {
                        if (!a) return -21;
                        var b = {__size__: 390, sysname: 0, nodename: 65, release: 130, version: 195, machine: 260, domainname: 325};
                ...
                }, Ba: Sc, qa: function (a, b) {
                    if (a == b) postMessage({cmd: "processQueuedMainThreadWork"}); else if (l) postMessage({
                        targetThread: a,
                    ...
                    for (var c = 0; c < a; c++) {
                        var d = E[b + 4 * c >> 2], e = $c[d];
                        e && (V.deleteBuffer(e), e.name = 0, $c[d] = null)
                    }
                }, bd: function (a, b) {
                    for (var c = 0; c < a; ++c) {
                        var d = E[b + 4 * c >> 2], e = ad[d];
                ...
                Tc: function (a) {
                    ...
                    if (c) if (a >= Zc) U(1281); else {
                        var d = gd[a];
                        if (d) if (35716 == b) a = V.getProgramInfoLog(S[a]), null === a && (a = "(unknown error)"), E[c >> 2] = a.length + 1; else if (35719 ==
                            b) E[c >> 2] = d.Wg; else if (35722 == b) {
                            if (-1 == d.ig) {
                                a = S[a];
                            ...
                            if (-1 == d.jg) for (a = S[a], e = V.getProgramParameter(a, 35382), b = d.jg = 0; b < e; ++b) d.jg = Math.max(d.jg, V.getActiveUniformBlockName(a, b).length + 1);
                            E[c >> 2] = d.jg
                        } else E[c >> 2] = V.getProgramParameter(S[a], b); else U(1282)
                    } else U(1281)
                }, Od: function (a, b, c) {
                    if (c) {
                    ...
                    for (var c = a.Mh, d = V.getProgramParameter(b, 35718), e = 0; e < d; ++e) {
                        var g = V.getActiveUniform(b, e), k = g.name;
                    ...
                    if (288 >= b) for (var d = yd[b - 1], e = 0; e < b; ++e) d[e] = G[c + 4 * e >> 2]; else d = G.subarray(c >> 2, c + 4 * b >> 2);
                    V.uniform1fv(T[a], d)
                }, zb: function (a, b) {
                    V.uniform1i(T[a], b)
                }, yb: function (a, b, c) {
                    if (288 >= b) for (var d = zd[b - 1], e = 0; e < b; ++e) d[e] = E[c + 4 * e >> 2]; else d = E.subarray(c >> 2, c + 4 * b >> 2);
                    V.uniform1iv(T[a], d)
                }, xb: function (a, b, c) {
                    V.uniform2f(T[a], b, c)
                }, wb: function (a,
                                 b, c) {
                    if (144 >= b) for (var d = yd[2 * b - 1], e = 0; e < 2 * b; e += 2) d[e] = G[c + 4 * e >> 2], d[e + 1] = G[c + (4 * e + 4) >> 2]; else d = G.subarray(c >> 2, c + 8 * b >> 2);
                    V.uniform2fv(T[a], d)
                }, vb: function (a, b, c) {
                    V.uniform2i(T[a], b, c)
                }, ub: function (a, b, c) {
                    if (144 >= b) for (var d = zd[2 * b - 1], e = 0; e < 2 * b; e += 2) d[e] = E[c + 4 * e >> 2], d[e + 1] = E[c + (4 * e + 4) >> 2]; else d = E.subarray(c >> 2, c + 8 * b >> 2);
                    V.uniform2iv(T[a], d)
                }, tb: function (a, b, c, d) {
                    V.uniform3f(T[a], b, c, d)
                }, sb: function (a, b, c) {
                    if (96 >= b) for (var d = yd[3 * b - 1], e = 0; e < 3 * b; e += 3) d[e] = G[c + 4 * e >> 2], d[e + 1] = G[c + (4 * e + 4) >> 2], d[e + 2] =
                        G[c + (4 * e + 8) >> 2]; else d = G.subarray(c >> 2, c + 12 * b >> 2);
                    V.uniform3fv(T[a], d)
                }, rb: function (a, b, c, d) {
                    V.uniform3i(T[a], b, c, d)
                }, qb: function (a, b, c) {
                    if (96 >= b) for (var d = zd[3 * b - 1], e = 0; e < 3 * b; e += 3) d[e] = E[c + 4 * e >> 2], d[e + 1] = E[c + (4 * e + 4) >> 2], d[e + 2] = E[c + (4 * e + 8) >> 2]; else d = E.subarray(c >> 2, c + 12 * b >> 2);
                    V.uniform3iv(T[a], d)
                    ...
                    if (72 >= b) for (var d = zd[4 * b - 1], e = 0; e < 4 * b; e += 4) d[e] = E[c + 4 * e >> 2], d[e + 1] = E[c + (4 * e + 4) >> 2], d[e + 2] = E[c + (4 * e + 8) >> 2], d[e + 3] = E[c + (4 * e + 12) >> 2]; else d = E.subarray(c >> 2, c + 16 * b >> 2);
                    V.uniform4iv(T[a], d)
                }, lb: function (a, b, c, d) {
                    if (72 >= b) for (var e = yd[4 * b - 1], g = 0; g < 4 * b; g += 4) e[g] = G[d + 4 * g >> 2], e[g + 1] = G[d + (4 * g + 4) >> 2], e[g + 2] = G[d + (4 * g + 8) >> 2], e[g + 3] = G[d + (4 * g + 12) >> 2]; else e = G.subarray(d >> 2, d + 16 * b >> 2);
                    V.uniformMatrix2fv(T[a],
                        !!c, e)
                }, kb: function (a, b, c, d) {
                    if (32 >= b) for (var e = yd[9 * b - 1], g = 0; g < 9 * b; g += 9) e[g] = G[d + 4 * g >> 2], e[g + 1] = G[d + (4 * g + 4) >> 2], e[g + 2] = G[d + (4 * g + 8) >> 2], e[g + 3] = G[d + (4 * g + 12) >> 2], e[g + 4] = G[d + (4 * g + 16) >> 2], e[g + 5] = G[d + (4 * g + 20) >> 2], e[g + 6] = G[d + (4 * g + 24) >> 2], e[g + 7] = G[d + (4 * g + 28) >> 2], e[g + 8] = G[d + (4 * g + 32) >> 2]; else e = G.subarray(d >> 2, d + 36 * b >> 2);
                    ...
                    c.uj = E[b + 13];
                    a = Ed(a);
                    if (!a || c.gi) c = 0; else if (a = a.getContext("webgl", c)) {
                        b = Ma(8);
                        E[b + 4 >> 2] = pb | 0;
                    ...
                    Cb(a)
                }, G: Md, T: Nd, ya: Od, Va: Pd, M: Qd, B: Sd, d: function () {
                    return Aa | 0
                }, w: Td, v: function (a, b, c, d, e, g, k) {
                    b = Oc(a, b);
                    if (b.df) return -6;
                    a = b.port;
                    var m = b.gf;
                    ...
                    M.oi()
                }, aa: ne, j: oe, h: pe, H: qe, ba: re, Z: se, O: te, Xa: ue, Wa: ve, k: we, x: xe, J: ye, g: ze,
                N: Ae, Sa: Be, Y: Ce, Ya: De, s: Nb, a: Ca || f.wasmMemory, S: function (a) {
                    Jb();
                    var b = new Date(E[a + 20 >> 2] + 1900, E[a + 16 >> 2], E[a + 12 >> 2], E[a + 8 >> 2], E[a + 4 >> 2], E[a >> 2], 0),
                        c = E[a + 32 >> 2], d = b.getTimezoneOffset(), e = new Date(b.getFullYear(), 0, 1),
                        g = (new Date(b.getFullYear(), 6, 1)).getTimezoneOffset(), k = e.getTimezoneOffset(), m = Math.min(k, g);
                    ...
                    if (b) {
                        ...
                        k = 0 !== E[b + 12 >> 2];
                        if (0 === E[b + 16 >> 2]) {
                            var t = E[b + 20 >> 2], w = E[b + 24 >> 2];
                            m = b + 20;
                            r = b + 24;
                            var B = M.Lg ? M.Lg : pb | 0;
                            if (m || r) if (B) if (E[B + 12 >> 2] !== B) u("pthread_getschedparam attempted on thread " +
                    ...
                    E[a >> 2] = a;
                    c = {
                        Qf: g, bg: q, Jg: b, Hh: m, Ih: r, detached: k, Li: c, Zf: t,
                        Ei: pb | 0, Sf: d, Ui: e
                    };
                    ...
                    q = {
                        "%a": function (p) {
                            ...
                            var x = new Date(p.qf + 1900, 0, 1), z = 0 === x.getDay() ? x : be(x, 7 - x.getDay());
                            ...
                            var x = new Date(p.qf + 1901, 0, 4), z = m(new Date(p.qf + 1900, 0, 4));
                            x = m(x);
                        ...
                        "%W": function (p) {
                            var x = new Date(p.qf, 0, 1), z = 1 === x.getDay() ? x : be(x, 0 === x.getDay() ? 1 : 7 - x.getDay() + 1);
                            p = new Date(p.qf + 1900, p.cg, p.og);
                            return 0 > k(z, p) ? g(Math.ceil((31 - z.getDate() + (Zd(Yd(p.getFullYear()) ? $d : ae, p.getMonth() - 1) - 31) + p.getDate()) / 7), 2) : 0 === k(z, x) ? "01" : "00"
                        }, "%y": function (p) {
            ...
            (function () {
                ...
                (function () {
                    ...
                    "function" !== typeof fetch ? c(b) : fetch(hb, {credentials: "same-origin"}).then(function (e) {
