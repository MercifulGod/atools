!function (e, t) {
    ...
    return e = {
        497: (e, t, r) => {
            var n = r(72), o = r(306).devDependencies;
            e.exports = {corePath: "undefined" != typeof process && "development" === process.env.FFMPEG_ENV ? n("/node_modules/@ffmpeg/core/dist/ffmpeg-core.js") : "/static/js/ffmpeg-core.js"}
        }, 663: (e, t, r) => {
            ...
            e.exports = function () {
                var e, t = (e = regeneratorRuntime.mark((function e(t) {
                    ...
                    return regeneratorRuntime.wrap((function (e) {
                        for (; ;) switch (e.prev = e.next) {
                            case 0:
                                if (r = t.corePath, void 0 !== window.createFFmpegCore) {
                                    e.next = 13;
                                    break
                                }
                                return i("info", "fetch ffmpeg-core.worker.js script"), n = o(r), e.next = 6, fetch(n.replace("ffmpeg-core.js", "ffmpeg-core.worker.js"));
                            case 6:
                                return e.next = 8, e.sent.blob();
                            case 8:
                                return a = e.sent, window.FFMPEG_CORE_WORKER_SCRIPT = URL.createObjectURL(a), i("info", "worker object URL=".concat(window.FFMPEG_CORE_WORKER_SCRIPT)), i("info", "download ffmpeg-core script (~25 MB) from ".concat(n)), e.abrupt("return", new Promise((function (e) {
                                    var t = document.createElement("script");
                                    t.src = n, t.type = "text/javascript", t.addEventListener("load", (function r() {
                                        t.removeEventListener("load", r), i("info", "initialize ffmpeg-core"), e(window.createFFmpegCore)
                                    })), document.getElementsByTagName("head")[0].appendChild(t)
                                })));
                            case 13:
                                return i("info", "ffmpeg-core is loaded already"), e.abrupt("return", Promise.resolve(window.createFFmpegCore));
                            case 15:
                            case"end":
                                return e.stop()
                        }
            ...
            var n = r(497), o = r(452), i = r(663);
            e.exports = {defaultOptions: n, getCreateFFmpegCore: o, fetchFile: i}
        }, 500: e => {
            e.exports = {
                defaultArgs: ["./ffmpeg", "-nostdin", "-y", "-hide_banner"], baseOptions: {
                    log: !1, logger: function () {
                    }, progress: function () {
                    }, corePath: ""
                }
            }
            ...
            var l = r(500), p = l.defaultArgs, h = l.baseOptions, m = r(185), d = m.setLogging, g = m.setCustomLogger, y = m.log, v = r(583),
                w = r(319), b = r(698), x = b.defaultOptions, E = b.getCreateFFmpegCore,
                O = Error("ffmpeg.wasm is not ready, make sure you have completed load().");
            e.exports = function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = s(s(s({}, h), x), e), r = t.log, o = t.logger,
                    i = t.progress, c = f(t, ["log", "logger", "progress"]), u = null, l = null, m = null, b = !1, j = i, F = function (e) {
                        "FFMPEG_END" === e && null !== m && (m(), m = null, b = !1)
                    }, L = function (e) {
                        var t = e.type, r = e.message;
                        y(t, r), v(r, j), F(r)
                    }, P = function () {
                            ...
                            return regeneratorRuntime.wrap((function (e) {
                                for (; ;) switch (e.prev = e.next) {
                                    case 0:
                                        ...
                                        return y("info", "loading ffmpeg-core"), e.next = 5, E(c);
                                    case 5:
                                        return t = e.sent, e.next = 8, t({
                                            printErr: function (e) {
                                                return L({type: "fferr", message: e})
                                            }, print: function (e) {
                                                return L({type: "ffout", message: e})
                                            }, locateFile: function (e, t) {
                                                return "undefined" != typeof window && void 0 !== window.FFMPEG_CORE_WORKER_SCRIPT && e.endsWith("ffmpeg-core.worker.js") ? window.FFMPEG_CORE_WORKER_SCRIPT : t + e
                                            }
                                        });
                                    case 8:
                                        u = e.sent, l = u.cwrap("proxy_main", "number", ["number", "number"]), y("info", "ffmpeg-core loaded"), e.next = 14;
                                        break;
                                    case 13:
                        ...
                        if (b) throw Error("ffmpeg.wasm can only run one command at a time");
                        return b = !0, new Promise((function (e) {
                ...
                return d(r), g(o), {setProgress: A, setLogger: R, setLogging: d, load: P, isLoaded: _, run: k, FS: S}
            }
        }, 352: (e, t, r) => {
            r(666);
            var n = r(906), o = r(698).fetchFile;
            e.exports = {createFFmpeg: n, fetchFile: o}
        }, 185: e => {
            var t = !1, r = function () {
            };
            e.exports = {
                logging: t, setLogging: function (e) {
                    t = e
            ...
            e.exports = function (e, t) {
                if ("string" == typeof e) if (e.startsWith("  Duration")) {
                    var o = e.split(", ")[0].split(": ")[1], i = n(o);
                    (0 === r || r > i) && (r = i)
            ...
            var t = function (e) {
                "use strict";
                var t, r = Object.prototype, n = r.hasOwnProperty, o = "function" == typeof Symbol ? Symbol : {}, i = o.iterator || "@@iterator",
                ...
                function u(e, t, r, n) {
                    var o = t && t.prototype instanceof g ? t : g, i = Object.create(o.prototype), a = new _(n || []);
                ...
                e.wrap = u;
                var l = "suspendedStart", p = "suspendedYield", h = "executing", m = "completed", d = {};
                ...
                function F(e, r) {
                    ...
                    if (n === t) {
                        if (r.delegate = null, "throw" === r.method) {
                            if (e.iterator.return && (r.method = "return", r.arg = t, F(e, r), "throw" === r.method)) return d;
                ...
                return y.prototype = E.constructor = v, v.constructor = y, y.displayName = s(v, c, "GeneratorFunction"), e.isGeneratorFunction = function (e) {
                    var t = "function" == typeof e && e.constructor;
                    return !!t && (t === y || "GeneratorFunction" === (t.displayName || t.name))
                }, e.mark = function (e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, v) : (e.__proto__ = v, s(e, c, "GeneratorFunction")), e.prototype = Object.create(E), e
                }, e.awrap = function (e) {
                    return {__await: e}
                ...
                }, O(E), s(E, c, "Generator"), E[i] = function () {
                    return this
                }, E.toString = function () {
                    ...
                    constructor: _, reset: function (e) {
                        if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(P), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t)
                    }, stop: function () {
                        this.done = !0;
